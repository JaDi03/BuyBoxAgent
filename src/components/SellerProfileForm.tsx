        ...
        <div className="p-4 space-y-3.5">
          <div>
            <label className="text-[10px] uppercase font-bold text-slate-500 flex items-center gap-1 mb-1">
              <User className="w-3 h-3" /> Store / Seller Name
            </label>
            <input 
              type="text" 
              value={companyName}
          ...
          <div>
            <label className="text-[10px] uppercase font-bold text-slate-500 flex items-center gap-1 mb-1">
              <Tag className="w-3 h-3" /> Product to Analyze
            </label>
            <input 
              type="text" 
              ...
              className="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-1.5 text-xs text-slate-200 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition"
              placeholder="e.g., Yeti Rambler 30oz"
              disabled={isLoading}
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="text-[10px] uppercase font-bold text-slate-500 flex items-center gap-1 mb-1">
                <DollarSign className="w-3 h-3" /> Your Price (MXN)
              </label>
              <input 
                type="number" 
                value={companyPrice}
            ...
            <div>
              ...
              <select 
                ...
                disabled={isLoading}
              >
                <option value="Sin medalla">No Badge</option>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              <label className="text-[10px] uppercase font-bold text-slate-500 flex items-center gap-1 mb-1">
                <Truck className="w-3 h-3" /> Shipping Model
              </label>
              <select 
                ...
                disabled={isLoading}
              >
                <option value="Mercado Envíos FULL">FULL Shipping</option>
                <option value="Mercado Envíos Colecta">Standard (Colecta)</option>
                <option value="Mercado Envíos Flex">Flex (Same-Day)</option>
                <option value="Acordar con vendedor">Arrange with Seller</option>
              </select>
            </div>
            ...
            <div>
              ...
              <select 
                ...
                disabled={isLoading}
              >
                <option value="Sin garantía">No Warranty</option>
                <option value="30 días de garantía">30-day warranty</option>
                <option value="90 días de garantía">90-day warranty</option>
                <option value="1 año de garantía">1-year warranty</option>
              </select>
            </div>
          </div>
